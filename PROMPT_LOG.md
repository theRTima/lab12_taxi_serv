...
- Что пришлось исправлять вручную: Создал секрет на github, создавал API в aistudio google, groq. Создал новую ветку для проверки работы Actions. 5 раза. Остановился на groq из-за наличия действительно бесплатной версии.
- Время: ~ 50 минут
---